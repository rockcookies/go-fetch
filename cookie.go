...
var ctxCookieKey = utils.NewContextKey[[]func(*CookieOptions)]("apply_cookie")

// ApplyCookie creates a middleware that applies cookie options from the request context.
...
func ApplyCookie() Middleware {
	return func(h Handler) Handler {
		return HandlerFunc(func(client *http.Client, req *http.Request) (*http.Response, error) {
			options, _ := getOptions(&ctxCookieKey, req, func() *CookieOptions {
...
// These functions will be executed by ApplyCookie to configure cookies.
...
func SetCookieOptions(opts ...func(*CookieOptions)) Middleware {
	return withOptionsMiddleware(&ctxCookieKey, opts...)
}
...
func WithCookieOptions(ctx context.Context, opts ...func(*CookieOptions)) context.Context {
	return withOptions(ctx, &ctxCookieKey, opts...)
}
